...
[Mixture-of-Top-k Attention: Efficient Attention via Scalable Fast Weights](https://arxiv.org/abs/2602.01219v5).

MiTA is a novel efficient attention mechanism that adopts a **compress-and-route strategy**, consisting of a compressed shared fast-weight expert and several routed **deformable** fast-weight experts.
...
## 🔧 Usage
We provide a pure implementation of MiTA in package [mita](https://github.com/QishuaiWen/MiTA/tree/main/mita), which can be a plug-in module in other tasks.
...
x = block(x)
```
Additionally, there are many variants of MiTA as well as other classical/newest efficient attention in the mita package. 
...
[2026/2/3] Released a pure implementation of MiTA at [here](https://github.com/QishuaiWen/MiTA/tree/main/MiTA%20Attention).
